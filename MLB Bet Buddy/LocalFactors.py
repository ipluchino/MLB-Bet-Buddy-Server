...
class LocalFactors():
    ...
    BALLPARK_INFORMATION = {
        ...
        'Fenway Park': { 'homeTeam': 'Boston Red Sox', 'ballparkFactor': 107, 'city': 'Boston', 'hasRoof': False },
        'Great American Ball Park': { 'homeTeam': 'Cincinnati Reds', 'ballparkFactor': 105, 'city': 'Cincinnati', 'hasRoof': False },
        'Kauffman Stadium': { 'homeTeam': 'Kansas City Royals', 'ballparkFactor': 104, 'city': 'Kansas City', 'hasRoof': False },
        'Nationals Park': { 'homeTeam': 'Washington Nationals', 'ballparkFactor': 101, 'city': 'Washington', 'hasRoof': False },
        'Globe Life Field': { 'homeTeam': 'Texas Rangers', 'ballparkFactor': 101, 'city': 'Arlington', 'hasRoof': True },
        'PNC Park': { 'homeTeam': 'Pittsburgh Pirates', 'ballparkFactor': 101, 'city': 'Pittsburgh', 'hasRoof': False },
        'Truist Park': { 'homeTeam': 'Atlanta Braves', 'ballparkFactor': 100, 'city': 'Atlanta', 'hasRoof': False },
        'Wrigley Field': { 'homeTeam': 'Chicago Cubs', 'ballparkFactor': 97, 'city': 'Chicago', 'hasRoof': False },
        'Citizens Bank Park': { 'homeTeam': 'Philadelphia Phillies', 'ballparkFactor': 101, 'city': 'Philadelphia', 'hasRoof': False },
        'Oriole Park at Camden Yards': { 'homeTeam': 'Baltimore Orioles', 'ballparkFactor': 99, 'city': 'Baltimore', 'hasRoof': False },
        'Chase Field': { 'homeTeam': 'Arizona Diamondbacks', 'ballparkFactor': 101, 'city': 'Phoenix', 'hasRoof': True },
        'Target Field': { 'homeTeam': 'Minnesota Twins', 'ballparkFactor': 102, 'city': 'Minneapolis', 'hasRoof': False },
        ...
        'Daikin Park': { 'homeTeam': 'Houston Astros', 'ballparkFactor': 100, 'city': 'Houston', 'hasRoof': True },
        'Rate Field': { 'homeTeam': 'Chicago White Sox', 'ballparkFactor': 99, 'city': 'Chicago', 'hasRoof': False },
        'Busch Stadium': { 'homeTeam': 'St. Louis Cardinals', 'ballparkFactor': 100, 'city': 'Saint Louis', 'hasRoof': False },
        'Dodger Stadium': { 'homeTeam': 'Los Angeles Dodgers', 'ballparkFactor': 100, 'city': 'Los Angeles', 'hasRoof': False },
        'Yankee Stadium': { 'homeTeam': 'New York Yankees', 'ballparkFactor': 100, 'city': 'Bronx', 'hasRoof': False },
        'loanDepot park': { 'homeTeam': 'Miami Marlins', 'ballparkFactor': 101, 'city': 'Miami', 'hasRoof': True },
        'Oracle Park': { 'homeTeam': 'San Francisco Giants', 'ballparkFactor': 97, 'city': 'San Francisco', 'hasRoof': False },
        'Comerica Park': { 'homeTeam': 'Detroit Tigers', 'ballparkFactor': 98, 'city': 'Detroit', 'hasRoof': False },
        ...
        'Citi Field': { 'homeTeam': 'New York Mets', 'ballparkFactor': 97, 'city': 'Queens', 'hasRoof': False },
        'Tropicana Field': { 'homeTeam': 'Tampa Bay Rays', 'ballparkFactor': 96, 'city': 'Saint Petersburg Florida', 'hasRoof': False },
        'Oakland Coliseum': {'homeTeam': 'Oakland Athletics', 'ballparkFactor': 97, 'city': 'Oakland', 'hasRoof': False },
        'Petco Park': { 'homeTeam': 'San Diego Padres', 'ballparkFactor': 96, 'city': 'San Diego', 'hasRoof': False },
        'T-Mobile Park': { 'homeTeam': 'Seattle Mariners', 'ballparkFactor': 91, 'city': 'Seattle', 'hasRoof': True },
        'George M. Steinbrenner Field': { 'homeTeam': 'Tampa Bay Rays', 'ballparkFactor': 100, 'city': 'Tampa', 'hasRoof': False },
        'Sutter Health Park': { 'homeTeam': 'The Athletics', 'ballparkFactor': 100, 'city': 'Sacramento', 'hasRoof': False }
    }
